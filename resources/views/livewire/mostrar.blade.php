        ...
        <x-slot name="content">
            ...
            <div class="flex justify-end">
                <div wire:click="cerrarModal"
                    class="inline-flex sm:hidden items-center justify-center px-4 py-2 lg:hover:cursor-pointer bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Cerrar</div>
                <button wire:click="cerrarModal"
                    class="hidden sm:inline-flex items-center justify-center px-4 py-2 lg:hover:cursor-pointer bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Cerrar</button>
            </div>
        </x-slot>
        <x-slot name="footer">
